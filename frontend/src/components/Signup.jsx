        ...
        <div className="w-6/12 rounded-md bg-slate-100 text-center flex font-Poppins">
            ...
            <div className="m-5 ml-12 text-left"> 
                ...
                <label className="block text-slate-600">Firstname
                    <input type="text" placeholder="Jane" className="border w-full h-8 rounded pl-3 mb-3" onChange={(e)=>{
                        setFirstname(e.target.value);
                    }}></input>
                </label>
                <label className="block text-slate-600">Lastname
                    <input type="text" placeholder="Smith" className="border w-full h-8 rounded pl-3 mb-3" onChange={(e)=>{
                ...
                <label className="block text-slate-600">Password
                    <input type="password" placeholder=". . . . . . . . ." className="border w-full h-8 rounded pl-3 mb-3 text-left" onChange={(e)=>{
