export default function Doctor_panel() {
  return (
    <div>
      ...
      <div>
        <div
          className="max-w-1xl w-full mx-auto
          ...
          <div className="w-2/3 p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="mt-4 text-gray-600 text-justify">
                Dr. Jordan Blake is a compassionate and skilled physician with
                over a decade of experience in family medicine. Known for her
                patient-centered approach, Dr. Blake combines clinical expertise
                with a deep commitment to each patient's overall well-being. She
                graduated with honors from Johns Hopkins University School of
                Medicine and completed her residency at Massachusetts General
                Hospital.{" "}
              </p>
            </div>
            <div className="mt-4">
